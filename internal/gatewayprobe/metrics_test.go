...
func TestParseTraefikMetricsMatchesHTTPRouteCandidates(t *testing.T) {
	routes := []RouteRef{{
		ID:         "gwr_123",
		Namespace:  "ns-demo",
		Name:       "luna-gateway-gwr-123",
		Candidates: routeCandidates("gwr_123", "ns-demo", "luna-gateway-gwr-123", []string{"demo.example.com"}),
	}}
	raw := `
# HELP traefik_router_responses_bytes_total Response bytes.
# TYPE traefik_router_responses_bytes_total counter
traefik_router_responses_bytes_total{router="ns-demo-luna-gateway-gwr-123-web@kubernetesgateway",code="200"} 2048
# HELP traefik_router_requests_total Requests.
# TYPE traefik_router_requests_total counter
traefik_router_requests_total{router="ns-demo-luna-gateway-gwr-123-web@kubernetesgateway",code="200"} 8
