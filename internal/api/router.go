...
func NewRouter(db *gorm.DB) *gin.Engine {
	...
	v1 := router.Group("/api/v1")
	{
		...
		v1.GET("/projects/:projectId/applications/:applicationId/modules", handlers.ListApplicationModules)
		v1.POST("/projects/:projectId/applications/:applicationId/modules", handlers.CreateApplicationModule)
		v1.PUT("/projects/:projectId/applications/:applicationId/modules/:moduleId", handlers.UpdateApplicationModule)
		v1.DELETE("/projects/:projectId/applications/:applicationId/modules/:moduleId", handlers.DeleteApplicationModule)
