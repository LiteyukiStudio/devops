  ...
  return (
    <div
      className={cn(
        ...
        variant === 'bordered' && 'rounded-container bg-surface-raised',
        variant === 'raised' && 'rounded-container bg-surface-raised shadow-raised',
        variant === 'inset' && 'rounded-container border border-border bg-surface-inset',
        className,
      )}
      data-slot="surface"
