      ...
      <div className="grid gap-4 lg:grid-cols-[360px_1fr]">
        <Card>
          ...
          <form className="grid gap-3" onSubmit={form.handleSubmit(values => createToken.mutate(values))}>
            <Field label="名称">
              <Input {...form.register('name')} placeholder="Git webhook trigger" />
            </Field>
            <Field label="Scope">
            ...
            <Field label="有效期天数">
              <Input type="number" {...form.register('expiresInDays')} />
            </Field>
            <Button disabled={createToken.isPending} type="submit">
              <Plus size={16} />
              创建 Token
            </Button>
          </form>
