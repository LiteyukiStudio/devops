const bootstrap = {
  ...
  tokenHint: 'Provided through server configuration by the deployment administrator and used only for first-time initialization.',
  tokenRequired: 'Enter the bootstrap token',
