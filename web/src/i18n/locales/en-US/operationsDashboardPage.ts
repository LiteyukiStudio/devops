const operationsDashboardPage = {
  ...
  emptyDescription: 'Add a Grafana dashboard or panel iframe URL in Site Settings to show it here.',
  invalidTitle: 'Invalid operations dashboard URL',
  invalidDescription: 'Enter a Grafana iframe URL that starts with http or https in Site Settings.',
