...
本文件是给 AI 编码代理的项目级开发规范。保持简短、可执行、少歧义；细节优先从 `docs/`、`docs-legacy/` 和现有代码中渐进读取。
...
1. `README.md`
2. `TODO.md`
3. `docs-legacy/01-产品与一体化方案.md`
4. `docs-legacy/07-代码健康检查SOP.md`
...
- 编写新功能或有逻辑改动时，必须同步更新 `docs/` 文档站内容；仅涉及旧文档归档时更新 `docs-legacy/`。影响计划、验收或状态时也必须更新 `TODO.md`。
